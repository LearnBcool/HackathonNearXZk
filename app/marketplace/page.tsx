                        ...
                        <div className="mt-4">
                          ...
                          <div className="space-y-2">
                            {frete.lances.map((lance) => (
                              <div key={lance.id} className="flex justify-between items-center p-2 bg-white rounded-md">
                                <div>
                                ...
                                <Button
                                  ...
                                  disabled={loadingAceite?.freteId === frete.id && loadingAceite?.lanceId === lance.id}
                                >
